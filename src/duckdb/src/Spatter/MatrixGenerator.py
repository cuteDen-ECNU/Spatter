...
def random_fraction_matrix(max = 20):
...
def Q_2_Affine_param(Q) -> str:
    ...
    if len(Q) == 2:
        Q_txt = f'{Q[0][0]}, {Q[0][1]}, {Q[1][0]}, {Q[1][1]}, {random.randint(0, 10000)}, {random.randint(0, 10000)}'
    elif len(Q) == 3:
        Q_txt = f'{Q[0][0]}, {Q[0][1]}, {Q[0][2]}, {Q[1][0]}, {Q[1][1]}, {Q[1][2]}, {Q[2][0]}, {Q[2][1]}, {Q[2][2]}, {random.randint(0, 10000)}, {random.randint(0, 10000)}, {random.randint(0, 10000)}'
    return Q_txt
